...
<core_principles>
1. **Standards First**: Always read and strictly follow `.junie/coding-standards.md`
...
**ALWAYS start by reading** `.junie/coding-standards.md` to ensure full compliance.

```
→ Read .junie/coding-standards.md
...
1. **Always read `.junie/coding-standards.md` FIRST**
