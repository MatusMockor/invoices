...
1. **Check compliance with coding standards** - All rules are defined in `.junie/coding-standards.md`
...
**All code examples (good vs bad) are provided in `.junie/coding-standards.md`**
