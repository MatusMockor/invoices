                                ...
                                <div class="mt-6 flex justify-between items-center">
                                    ...
                                    <div class="flex space-x-2">
                                        ...
                                        <div class="group relative">
                                            <button id="dropdown-button-{{ $company->id }}" aria-expanded="false" aria-haspopup="true" class="inline-flex items-center text-xs px-2.5 py-1.5 border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3" viewBox="0 0 20 20" fill="currentColor">
                                                    <path d="M10 6a2 2 0 110-4 2 2 0 010 4zM10 12a2 2 0 110-4 2 2 0 010 4zM10 18a2 2 0 110-4 2 2 0 010 4z" />
                                                </svg>
                                            </button>
                                            <div id="dropdown-menu-{{ $company->id }}" class="hidden absolute right-0 mt-2 w-40 rounded-md shadow-lg bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 z-10">
                                                <div class="py-1" role="menu" aria-orientation="vertical" aria-labelledby="dropdown-button-{{ $company->id }}">
                                                    <a href="{{ route('companies.edit', $company) }}" class="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700" role="menuitem">
                                                    ...
                                                    <form method="POST" action="{{ route('companies.destroy', $company) }}" class="block w-full" onsubmit="return confirm('{{ __('Are you sure you want to delete this company?') }}');">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="flex items-center w-full text-left px-4 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-gray-100 dark:hover:bg-gray-700" role="menuitem">
