            ...
            <form method="POST" action="{{ route('companies.store') }}" class="space-y-8">
                ...
                <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden">
                    <div class="p-6 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('Enter the basic details of your company.') }}</p>
                    </div>
                ...
                <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden">
                    <div class="p-6 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('Enter your company\'s registration and tax information.') }}</p>
                    </div>
                    <div class="p-6 bg-white dark:bg-gray-800">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="iban" class="block mt-1 w-full" type="text" name="iban" :value="old('iban')" placeholder="SK82 8330 0000 0022 0012 3456" />
                            ...
                            <div>
                                ...
                                <x-text-input id="swift" class="block mt-1 w-full" type="text" name="swift" :value="old('swift')" placeholder="TATRSKBX" />
                ...
                <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden">
                    <div class="p-6 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('Enter contact details for your company.') }}</p>
                    </div>
                    <div class="p-6 bg-white dark:bg-gray-800">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex rounded-md shadow-sm">
                                    ...
                                    <x-text-input id="email" type="email" name="email" :value="old('email')" class="flex-1 block w-full rounded-none rounded-r-md" placeholder="info@company.com" />
                                </div>
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex rounded-md shadow-sm">
                                    ...
                                    <x-text-input id="website" type="url" name="website" :value="old('website')" class="flex-1 block w-full rounded-none rounded-r-md" placeholder="https://www.company.com" />
                                </div>
