                    ...
                    <div class="p-6 bg-white dark:bg-gray-800 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <x-text-input id="street" class="block mt-1 w-full" type="text" name="street" :value="old('street', $company->street)" required />
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                <div class="col-span-2">
                                    ...
                                    <x-text-input id="city" class="block mt-1 w-full" type="text" name="city" :value="old('city', $company->city)" required />
                                    <x-input-error :messages="$errors->get('city')" class="mt-2" />
                                </div>
                                <div>
                                    <x-input-label for="postal_code" :value="__('Postal Code *')" class="font-semibold" />
                                    <x-text-input id="postal_code" class="block mt-1 w-full" type="text" name="postal_code" :value="old('postal_code', $company->postal_code)" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="country" class="block mt-1 w-full" type="text" name="country" :value="old('country', $company->country)" required />
                    ...
                    <div class="p-6 bg-white dark:bg-gray-800">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="ico" class="block mt-1 w-full" type="text" name="ico" :value="old('ico', $company->ico)" required />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="registration_number" class="block mt-1 w-full" type="text" name="registration_number" :value="old('registration_number', $company->registration_number)" required />
