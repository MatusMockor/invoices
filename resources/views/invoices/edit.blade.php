        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div class="bg-white p-6 rounded-lg shadow">
                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <div>
                        <label for="constant_symbol" class="block text-sm font-medium text-gray-700">Konštantný symbol</label>
                        <input type="text" name="constant_symbol" id="constant_symbol" value="{{ old('constant_symbol', $invoice->constant_symbol) }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('fetch-company-btn').addEventListener('click', function() {
                ...
                fetch('{{ route('partners.fetch-by-ico') }}?ico=' + ico, {
                    method: 'GET',
                    headers: {
