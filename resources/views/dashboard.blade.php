                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
                            <h3 class="text-lg font-semibold mb-4 text-gray-900 dark:text-gray-100">Faktúry</h3>
                            <p class="mb-4 text-gray-600 dark:text-gray-400">Spravujte všetky vaše faktúry na jednom mieste.</p>
                        ...
                        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
                            <h3 class="text-lg font-semibold mb-4 text-gray-900 dark:text-gray-100">Obchodné subjekty</h3>
                            <p class="mb-4 text-gray-600 dark:text-gray-400">Spravujte všetky spoločnosti, s ktorými obchodujete.</p>
                            <div class="flex space-x-4">
                                <a href="{{ route('business-entities.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-800 dark:bg-gray-700 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 dark:hover:bg-gray-600 focus:bg-gray-700 active:bg-gray-900 dark:active:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150">
                                    Zobraziť spoločnosti
                                </a>
                                <a href="{{ route('business-entities.create') }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-500 focus:bg-indigo-500 active:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150">
                                    Pridať spoločnosť
                                </a>
                            </div>
                        </div>
                        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
                            <h3 class="text-lg font-semibold mb-4 text-gray-900 dark:text-gray-100">Firmy</h3>
                            <p class="mb-4 text-gray-600 dark:text-gray-400">Spravujte všetky svoje spoločnosti, s ktorými obchodujete.</p>
                            <div class="flex space-x-4">
