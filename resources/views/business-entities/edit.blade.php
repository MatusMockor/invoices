        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('business-entities.update', $businessEntity) }}" class="space-y-8">
                    ...
                    <div class="p-6 bg-white dark:bg-gray-800 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <x-text-input id="dic" class="block mt-1 w-full" type="text" name="dic" :value="old('dic', $businessEntity->dic)" />
                            ...
                            <div>
                                ...
                                <x-text-input id="ic_dph" class="block mt-1 w-full" type="text" name="ic_dph" :value="old('ic_dph', $businessEntity->ic_dph)" />
                    ...
                    <div class="p-6 bg-white dark:bg-gray-800 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <x-text-input id="street" class="block mt-1 w-full" type="text" name="street" :value="old('street', $businessEntity->street)" required />
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                <div class="col-span-2">
                                    ...
                                    <x-text-input id="city" class="block mt-1 w-full" type="text" name="city" :value="old('city', $businessEntity->city)" required />
                                    <x-input-error :messages="$errors->get('city')" class="mt-2" />
                                </div>
                                <div>
                                    <x-input-label for="postal_code" :value="__('Postal Code *')" class="font-semibold" />
                                    <x-text-input id="postal_code" class="block mt-1 w-full" type="text" name="postal_code" :value="old('postal_code', $businessEntity->postal_code)" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="country" class="block mt-1 w-full" type="text" name="country" :value="old('country', $businessEntity->country)" required />
                    ...
                    <div class="p-6 bg-white dark:bg-gray-800 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="registration_number" class="block mt-1 w-full" type="text" name="registration_number" :value="old('registration_number', $businessEntity->registration_number)" required />
                ...
                <div class="flex items-center justify-end space-x-4">
                    <a href="{{ route('business-entities.index') }}" class="inline-flex items-center px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md font-semibold text-xs text-gray-700 dark:text-gray-300 uppercase tracking-widest shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 disabled:opacity-25 transition ease-in-out duration-150">
                        {{ __('Cancel') }}
                    </a>
